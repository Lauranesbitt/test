...
class ClinicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clinic" do
    assert_difference('Clinic.count') do
      post clinics_url, params: { clinic: { clinicaddress: @clinic.clinicaddress, clinicname: @clinic.clinicname, clinicnumber: @clinic.clinicnumber } }
    end
  ...
  test "should update clinic" do
    patch clinic_url(@clinic), params: { clinic: { clinicaddress: @clinic.clinicaddress, clinicname: @clinic.clinicname, clinicnumber: @clinic.clinicnumber } }
