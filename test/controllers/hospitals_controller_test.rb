...
class HospitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post hospitals_url, params: { hospital: { hospitaladdress: @hospital.hospitaladdress, hospitalname: @hospital.hospitalname, hospitalnumber: @hospital.hospitalnumber } }
    end
  ...
  test "should update hospital" do
    patch hospital_url(@hospital), params: { hospital: { hospitaladdress: @hospital.hospitaladdress, hospitalname: @hospital.hospitalname, hospitalnumber: @hospital.hospitalnumber } }
